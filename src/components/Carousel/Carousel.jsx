...
const Carousel = () => (
    <Flickity className="cursor-pointer overflow-hidden outline-none relative mt-11 text-gray-500" options={{wrapAround: true}} >
      <Image src={slideOne} alt="Barber trimming beard" style={{ "padding": "20px"}}/>
