    ...
    <footer className="relative bg-gray-800 text-gray-300 text-center py-10 sm:px-6 lg:px-8 mt-20">
      <div className="flex max-w-sm mx-auto justify-around sm:justify-between mb-8">
        ...
        {/* <a className='p-2 hover:text-gray-50' href="https://www.google.com" target="_blank">
                    <svg width="30" height="30" fill="currentColor" className="text-xl transition-colors duration-200" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
      ...
      <p className="px-4">
        Copyright &#169; {`${new Date().getFullYear()}`} Republic Barbershop.
        All rights reserved.
      </p>
      <a
        href="#top"
