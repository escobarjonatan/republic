const Footer = () => {
    ...
    return (
        <footer className='relative bg-gray-800 text-gray-300 text-center py-10 sm:px-6 lg:px-8 mt-20'>
            <div className='flex max-w-sm mx-auto justify-around sm:justify-between mb-8'>
                <a className='p-2 hover:text-gray-50' href="https://www.google.com" target="_blank">
                    <svg width="30" height="30" fill="currentColor" class="text-xl transition-colors duration-200" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1343 12v264h-157q-86 0-116 36t-30 108v189h293l-39 296h-254v759h-306v-759h-255v-296h255v-218q0-186 104-288.5t277-102.5q147 0 228 12z">
                        </path>
                    </svg>
                </a>
                <a className='p-2 hover:text-gray-50' href="https://www.google.com" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="text-xl transition-colors duration-200" width="27" height="27" viewBox="0 0 512 512" style={{ "enable-background": "new 0 0 512 512" }} xmlspace="preserve">
            ...
            <p className="px-4">Copyright &#169; {`${new Date().getFullYear()}`} Republic Barbershop. All rights reserved.</p>
            <a href="#top" className="absolute text-lg -top-14 right-3 border-2 text-gray-800 border-gray-800 focus:ring-4 rounded-lg text-center px-3 -rotate-90" aria-label="Scroll to Top">&#10140;</a>
        </footer>
    );
};
