...
const Logo = ({ wrapperClasses = '' }) => {
    ...
    return (
        <a
            ...
            href="/" title='Republic Barbershop Home'
            ...
            <div className='relative'>
                ...
                <span
                    className={`font-sans font-bold absolute ${styles.barbershop}`}>
                    BARBERSHOP
                </span>
            </div>
        </a>
...
//                         <img className="block lg:hidden h-8 w-auto" src="/republic.jpeg" alt="Workflow" />
//                         <img className="hidden lg:block h-8 w-auto" src="/republic.jpeg" alt="Workflow" />
//                     </div>
